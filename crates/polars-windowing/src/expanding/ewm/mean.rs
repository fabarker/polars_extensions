...
use polars_arrow::legacy::kernels::ewm::{
    ewm_mean as kernel_ewm_mean,
};
...
pub fn ewm_mean(s: &Series,
    ...
    match s.dtype() {
        ...
        _ => ewm_mean(&s.cast(&DataType::Float64)?, alpha, adjust, min_periods, ignore_nulls),
    }
}