...
use pyo3_polars::export::polars_plan::prelude::{ApplyOptions, FunctionFlags, FunctionOptions, GetOutput};
...
impl MyCustomTrait for Expr {
    ...
    fn rolling_cagr(self, options: RollingOptionsFixedWindow) -> Self {
        self.map_custom(move |s| rolling_cagr_with_opts(&s, options.clone()),
